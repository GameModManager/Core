...
[[nodiscard]] std::optional<std::vector<IniEdit>>
parse_ini_content(const std::string &content, std::string *error = nullptr,
...
[[nodiscard]] std::optional<IniEditFile>
parse_ini_edit_file(const std::string &json_text, std::string *error = nullptr);
...
// not conflicts.
[[nodiscard]] std::vector<MergedTarget>
merge_ini_edits(const std::vector<IniEditFile> &files);
...
apply_ini_edits(const std::string &current_text, const MergedTarget &merged,
...
[[nodiscard]] RetractOutcome
retract_ini_edits(const std::string &current_text,
...
[[nodiscard]] RetractOutcome retract_ini_tweak(const std::string &current_text,
                                               const std::vector<AppliedEdit> &state,
...
[[nodiscard]] std::string applied_state_to_json(const std::vector<AppliedEdit> &state);
[[nodiscard]] std::vector<AppliedEdit>
applied_state_from_json(const std::string &json_text, std::string *error = nullptr);
