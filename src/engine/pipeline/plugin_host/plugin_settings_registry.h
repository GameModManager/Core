...
public:
  ...
  // count = 0 = no-op.
  void register_settings(const std::string &plugin_id, const char *const *keys,
  ...
  void register_settings_tab(const std::string &plugin_id, const char *title,
                             const char *const *keys, const char *const *types,
                             const char *const *defaults, const char *const *options,
                             size_t count);
