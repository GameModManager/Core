...
public:
  ...
  Diagnostics validate(const nlohmann::json &value, const nlohmann::json &schema);
...
private:
  Diagnostics validate_impl(const nlohmann::json &value, const nlohmann::json &schema,
                            const nlohmann::json &root_schema, const std::string &path);
