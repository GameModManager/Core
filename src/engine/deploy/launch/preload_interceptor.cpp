...
int64_t PreloadInterceptor::launch(const std::filesystem::path &executable,
  ...
  Logger::instance().debug(
      "PreloadInterceptor::launch() executable=" + executable.string() +
    ...
    if (result == pid) {
      ...
      if (WIFEXITED(status)) {
        ...
        case 5:
          ...
          break;
        case 12:
          reason = "chdir(game_dir) failed";
          break;
        case 13:
          reason = "setenv(GMM_GAME_DIR) failed";
          break;
        case 14:
          reason = "setenv(GMM_OVERWRITE_DIR) failed";
          break;
        case 15:
          reason = "setenv(LD_PRELOAD) failed";
          break;
        default:
