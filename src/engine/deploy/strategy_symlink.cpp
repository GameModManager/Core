...
Symlink::Symlink(bool case_sensitive) : case_sensitive_(case_sensitive) {}

bool Symlink::deploy(const std::filesystem::path &source,
...
bool Symlink::remove(const std::filesystem::path &target) {
  std::error_code ec;
