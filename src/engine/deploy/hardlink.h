...
class Hardlink : public Interface {
public:
  ...
  // Check if source and target are on the same filesystem (required for
  // hardlinks).
  [[nodiscard]] static bool same_volume(const std::filesystem::path &a,
