...
bool Hardlink::same_volume(const std::filesystem::path &a,
...
bool Hardlink::deploy(const std::filesystem::path &source,
...
bool Hardlink::remove(const std::filesystem::path &target) {
  std::error_code ec;
