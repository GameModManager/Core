...
void SortRegistry::register_provider(const std::string& game_id, std::unique_ptr<SortProvider> provider) {
...
SortProvider* SortRegistry::get_provider(const std::string& game_id) const {
