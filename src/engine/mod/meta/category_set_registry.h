...
// CategoryFactory::instance() pattern. Built-in sets ("Default", "Bethesda",
// "Isaac") are registered in the constructor; plugins or future user/third-party
// code can add more via register_set().
//
