...
const CategorySetDefinition *
CategorySetRegistry::find(const std::string &set_name) const {
...
void CategorySetRegistry::register_builtin_sets() {
  ...
  // behavior. Kept verbatim for fidelity with MO2's category file format.
  {
    ...
    def.categories.assign(kBethesda,
                          kBethesda + sizeof(kBethesda) / sizeof(kBethesda[0]));
    register_set(std::move(def));
  }
  ...
  // IDs 1000..1021, parent hierarchy as in the plugin.
  {
    static const CategorySetEntry kIsaac[] = {
        {1000, "Items", 0},       {1001, "Active Items", 1000},
        {1002, "Trinkets", 1000}, {1003, "Pills", 1000},
        {1004, "Cards", 1000},    {1005, "Pickups", 1000},
        {1006, "Lua", 0},         {1007, "Rooms", 0},
        {1008, "Floors", 1007},   {1009, "Player Characters", 0},
        {1010, "Familiars", 0},   {1011, "Babies", 0},
        {1012, "Enemies", 0},     {1013, "Graphics", 0},
        {1014, "Shaders", 1013},  {1015, "Sound Effects", 0},
        {1016, "Music", 1015},    {1017, "Bosses", 0},
        {1018, "Hazards", 0},     {1019, "Challenges", 0},
        {1020, "Tweaks", 0},      {1021, "Removals", 0},
    };
    CategorySetDefinition def;
    def.set_name     = "Isaac";
    def.display_name = "TheBindingOfIsaac Categories";
    def.description =
        "The Binding of Isaac: Rebirth Steam Workshop category hierarchy.";
