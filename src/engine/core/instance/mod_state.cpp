...
const ModTrackingEntry* ModStateTracker::entry(
...
void ModStateTracker::set_disabled(const std::string& folder_name,
                                   bool disabled) {
...
void ModStateTracker::set_deploy_at_root(const std::string& folder_name,
                                         bool at_root) {
