...
InstanceOptionsDialog::InstanceOptionsDialog(
  ...
  content_     = new InstanceOptionsWidget(
      platform, plugin_loader, game_id, game_display_name, game_dir, steam_appid,
      instance_root, current_runner, current_deploy_strategy, deploy_config, this);
  ...
  connect(content_, &InstanceOptionsWidget::save_requested, this, &QDialog::accept);
  connect(content_, &InstanceOptionsWidget::cancel_requested, this, &QDialog::reject);
}
