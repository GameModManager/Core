...
public:
  FomodWizardDialog(const std::shared_ptr<engine::FomodViewModel> &view_model,
                    ...
                    QString previous_choices, bool always_restore_choices,
                    bool show_images, QWidget *parent = nullptr);
...
private:
  ...
  QWidget *render_group(engine::GroupRef group,
  ...
  QCheckBox *create_plugin_checkbox(engine::PluginRef plugin, engine::GroupRef group,
                                    const std::shared_ptr<engine::StepViewModel> &step,
                                    QWidget *parent);
  void render_select_exactly_one(QWidget *parent, QLayout *parent_layout,
                                 engine::GroupRef group,
                                 const std::shared_ptr<engine::StepViewModel> &step);
  void render_checkbox_group(QWidget *parent, QLayout *parent_layout,
                             engine::GroupRef group,
                             const std::shared_ptr<engine::StepViewModel> &step);
  QButtonGroup *render_radio_group(QWidget *parent, QLayout *parent_layout,
                                   engine::GroupRef group,
                                   const std::shared_ptr<engine::StepViewModel> &step);
  void update_could_be_usable_indicator(QAbstractButton *button,
  ...
  void on_plugin_toggled(bool selected, engine::GroupRef group,
                         engine::PluginRef plugin);
