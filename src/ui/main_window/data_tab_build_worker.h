...
struct DataTabRow {
  ...
  bool operator==(const DataTabRow &o) const {
    return path == o.path && vfs_path == o.vfs_path && real_path == o.real_path &&
           origin_id == o.origin_id && source == o.source && size == o.size &&
           providers == o.providers && hidden == o.hidden &&
           all_sources == o.all_sources && provider_paths == o.provider_paths &&
