...
bool TextFilesTab::wants_file(const QString &rel_path, const QString &full_path) const {
  Q_UNUSED(rel_path)
  ...
  static const QStringList kExtensions = {
      ...
      QStringLiteral(".xml"), QStringLiteral(".log"),  QStringLiteral(".lua"),
      QStringLiteral(".py"),  QStringLiteral(".html"), QStringLiteral(".htm"),
      QStringLiteral(".css"), QStringLiteral(".js"),   QStringLiteral(".csv"),
      QStringLiteral(".bat"), QStringLiteral(".cmd"),  QStringLiteral(".sh"),
      QStringLiteral(".ps1"), QStringLiteral(".sse"),
  };
