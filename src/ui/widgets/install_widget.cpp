...
void InstallStepModel::set_diagnostic_preview(InstallStep step, const QString& preview)
{
  const int row = row_of(step);
...
void InstallWidget::set_prior_choices(const engine::Collection::PriorChoiceState& prior)
{
