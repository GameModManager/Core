...
PipelineContentWidget::PipelineContentWidget(QWidget* parent)
    : QWidget(parent) {
...
void PipelineContentWidget::rebuild_cards(FlowTab& tab,
...
void PipelineContentWidget::update_cards(FlowTab& tab,
                                         const std::vector<engine::TraceStage>& stages) {
