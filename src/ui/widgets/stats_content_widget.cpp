...
void StatsContentWidget::refresh() {
  ...
  auto logs_dir      = std::filesystem::path(engine::CrashHandler::default_dump_dir());
  ...
  instance_size_label_->setText(QString::fromStdString(format_size(instance_bytes)));
  ...
  downloads_size_label_->setText(QString::fromStdString(format_size(downloads_bytes)));
