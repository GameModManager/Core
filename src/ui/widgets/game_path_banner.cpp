...
GamePathBanner::GamePathBanner(QWidget *parent) : QWidget(parent) {
  ...
  layout->addWidget(
      new QLabel(tr("No game directory is set for this instance: mods can be managed "
...
void GamePathBanner::set_instance_state(bool instance_loaded, bool has_game_dir) {
