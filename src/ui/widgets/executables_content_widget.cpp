...
namespace Executables {
  ...
  ContentWidget::ContentWidget(const std::filesystem::path &game_dir,
    ...
    output_mod_combo_->setToolTip(
        tr("Type a mod name or pick one from the list. A name that is not in the\n"
    ...
    connect(remove_btn_, &QToolButton::clicked, this, &ContentWidget::on_remove_entry);
    connect(up_btn_, &QToolButton::clicked, this, &ContentWidget::on_up_clicked);
    connect(down_btn_, &QToolButton::clicked, this, &ContentWidget::on_down_clicked);
    ...
    connect(browse_bin, &QPushButton::clicked, this, &ContentWidget::browse_binary);
    connect(browse_cwd, &QPushButton::clicked, this, &ContentWidget::browse_start_in);
