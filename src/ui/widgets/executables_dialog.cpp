...
namespace Executables {
  ...
  Dialog::Dialog(const std::filesystem::path &game_dir,
    ...
    content_ =
        new ContentWidget(game_dir, mod_list, initial_entries, icon_cache_dir, this);
    ...
    connect(content_, &ContentWidget::save_requested, this, &QDialog::accept);
    connect(content_, &ContentWidget::cancel_requested, this, &QDialog::reject);
  }
