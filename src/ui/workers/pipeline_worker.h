...
public slots:
  ...
  void run(const std::string &id, engine::Mod mod, const std::string &mods_dir);

signals:
  void download_progress(const std::string &mod_id, int64_t bytes_downloaded,
                         int64_t bytes_total, double speed_bytes_per_sec);
  void download_meta(const std::string &mod_id, const std::string &archive_name,
...
public slots:
  ...
  void download_modl(const std::string &id, const engine::Source::ModlLink &link,
                     const std::string &game_id, const std::string &mods_dir);
...
signals:
  void progress(const std::string &mod_id, int stage_index,
