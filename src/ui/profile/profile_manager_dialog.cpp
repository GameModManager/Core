...
ProfileManagerDialog::ProfileManagerDialog(const std::filesystem::path& profiles_dir,
  ...
  connect(delete_btn_, &QPushButton::clicked, this,
          &ProfileManagerDialog::on_delete_profile);
  connect(default_btn_, &QPushButton::clicked, this,
          &ProfileManagerDialog::on_set_default);
  ...
  connect(settings_widget_, &ProfileSettingsWidget::settings_changed, this, [this]() {
