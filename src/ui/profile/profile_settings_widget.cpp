...
ProfileSettingsWidget::ProfileSettingsWidget(QWidget *parent) : QWidget(parent) {
  ...
  connect(local_saves_box_, &QCheckBox::toggled, this, [this](bool) {
    emit settings_changed();
  });
  connect(local_settings_box_, &QCheckBox::toggled, this, [this](bool) {
    emit settings_changed();
  });
  connect(invalidation_box_, &QCheckBox::toggled, this, [this](bool) {
    emit settings_changed();
  });
}
