...
// Testable seam for the Delete Profile confirmation (Workspace-iqry): fills
// a TaskDialog with the Delete Profile title, the profile name plus the
// removal warning as the main text, a cannot-be-undone note as content, the
// profile directory path in the details pane, a Question icon, and Yes/No
...
public:
  ...
  ProfileManagerDialog(const std::filesystem::path& profiles_dir,
                       ...
                       const QString& default_profile = {}, QWidget* parent = nullptr);
