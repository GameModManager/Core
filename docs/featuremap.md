...
|-------------|--------|---------|
| MO2 parity  |204/365 |   56%   |
|GMM surpasses|   161  |   44%   |
|   Missing   |   158  |   43%   |
...
| Feature | MO2 | GMM | Status |
|---------|-----|-----|--------|
| System tray icon | ✅ `SystemTrayManager` | ⚠️ `SystemTrayManager` (exists, not wired up) | ⚠️ |
