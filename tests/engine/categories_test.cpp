...
TEST_CASE("categories", "[engine]") {
  ...
  require(gameplay && gameplay->name == "Gameplay", "category 1000 is Gameplay");
  ...
  require(children.size() == 12, "Gameplay has 12 children");
  const auto *modding = seeded.find(1800);
  require(modding && modding->parent_id == 1700, "Modding is a child of Technical");
  ...
  write_file(root / "categories.dat", "1|Animations|0\n"
                                      ...
                                      "10|Body, Face, & Hair|0\n"
                                      "39|Tattoos|10\n");
  write_file(root / "nexuscatmap.dat", "1|Miscellaneous|13\n"
                                       "1|Skins Textures|25\n");

  Categories loaded = Categories::load(root);
  require(loaded.contains(1) && loaded.contains(52), "load reads categories.dat");
  require(loaded.children_of(1).size() == 1 && loaded.children_of(1)[0]->id == 52,
          "Poses is child of Animations after load");
  require(loaded.children_of(10).size() == 1 && loaded.children_of(10)[0]->id == 39,
  ...
  write_file(root / "categories.dat", "1|Animations|13,25|0\n2|Armour|0\n");
  ...
  require(cats.find(100)->has_children, "has_children true once a child is added");
