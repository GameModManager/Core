...
TEST_CASE("parse_mod_entry: LoversLab with int modId",
          "[gmmpack][mod_entry]") {
    auto j = mod_json();
...
TEST_CASE("parse_mod_entry: LoversLab with string modId",
          "[gmmpack][mod_entry]") {
    auto j = mod_json();
    j["source"] = {{"provider", "loverslab"},
                   {"resolution", "browser"},
...
TEST_CASE("parse_mod_entry: ModPub with int modId",
          "[gmmpack][mod_entry]") {
    auto j = mod_json();
...
TEST_CASE("parse_mod_entry: ModPub with string modId",
          "[gmmpack][mod_entry]") {
    auto j = mod_json();
    j["source"] = {{"provider", "modpub"},
                   {"resolution", "api"},
...
TEST_CASE("parse_mod_entry: Steam Workshop (always latest)",
          "[gmmpack][mod_entry]") {
    auto j = mod_json();
...
TEST_CASE("parse_mod_entry: Steam Workshop with null version",
          "[gmmpack][mod_entry]") {
    auto j = mod_json();
    j["source"] = {{"provider", "steam_workshop"},
                   {"resolution", "client-subscription"},
...
TEST_CASE("parse_mod_entry: Direct latest (no version/hash)",
          "[gmmpack][mod_entry]") {
    auto j = mod_json();
    j["source"] = {{"provider", "direct"},
                   {"resolution", "browser"},
...
TEST_CASE("parse_mod_entry: category required",
          "[gmmpack][mod_entry]") {
    auto j = mod_json();
    j["category"] = "required";
    auto m = gmmpack::parse_mod_entry(j);
...
TEST_CASE("parse_mod_entry: category optional",
          "[gmmpack][mod_entry]") {
    auto j = mod_json();
    j["category"] = "optional";
    auto m = gmmpack::parse_mod_entry(j);
...
TEST_CASE("parse_mod_entry: category recommended",
          "[gmmpack][mod_entry]") {
    auto j = mod_json();
...
TEST_CASE("parse_mod_entry: category default on empty string",
          "[gmmpack][mod_entry]") {
    auto j = mod_json();
    j["category"] = "";
    auto m = gmmpack::parse_mod_entry(j);
...
TEST_CASE("parse_mod_entry: phase default is 0",
          "[gmmpack][mod_entry]") {
    auto j = mod_json();
    j.erase("phase");
    auto m = gmmpack::parse_mod_entry(j);
...
TEST_CASE("parse_mod_entry: phase parsed correctly",
          "[gmmpack][mod_entry]") {
    auto j = mod_json();
    j["phase"] = 5;
    auto m = gmmpack::parse_mod_entry(j);
...
TEST_CASE("parse_mod_entry: installerChoices present",
          "[gmmpack][mod_entry]") {
    auto j = mod_json();
    j["installerChoices"] = {
        {"type", "fomod"},
        {"selections",
         {{"step1", {"optionA", "optionB"}}, {"step2", {"optionC"}}}}};
    auto m = gmmpack::parse_mod_entry(j);
...
TEST_CASE("parse_mod_entry: installerChoices absent",
          "[gmmpack][mod_entry]") {
    auto j = mod_json();
...
TEST_CASE("parse_mod_entry: unknown provider falls back to Nexus",
          "[gmmpack][mod_entry]") {
    auto j = mod_json();
    j["source"] = {{"provider", "unknown_provider"},
                   {"resolution", "browser"}};
    auto m = gmmpack::parse_mod_entry(j);
...
TEST_CASE("parse_mod_entry: minimal required fields only",
          "[gmmpack][mod_entry]") {
    nlohmann::json j;
    j["id"] = "minimal";
    j["name"] = "Minimal Mod";
