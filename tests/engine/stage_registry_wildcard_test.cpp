...
TEST_CASE("stage registry wildcard", "[engine]") {
  ...
  SECTION("exact-match beats wildcard at equal priority") {
    ...
    reg.register_claim("SkyrimSE", "Fomod", exact.make_handler("SkyrimSE", "Fomod"), 10,
                       "exact");
  ...
  SECTION("multiple exact-match — highest priority wins") {
    StageRegistry reg;
    CallTracker low, high;
    reg.register_claim("SkyrimSE", "Fomod", low.make_handler("SkyrimSE", "Fomod"), 5,
                       "low");
    reg.register_claim("SkyrimSE", "Fomod", high.make_handler("SkyrimSE", "Fomod"), 15,
                       "high");
  ...
  SECTION("has_claim — exact matches only its game") {
    StageRegistry reg;
    CallTracker t;
    reg.register_claim("SkyrimSE", "Fomod", t.make_handler("SkyrimSE", "Fomod"), 10,
                       "exact");
  ...
  SECTION("claims vector contains all registered claims") {
    ...
    CallTracker t;
    reg.register_claim("", "Fomod", t.make_handler("", "Fomod"), 10, "wild");
    reg.register_claim("SkyrimSE", "Fomod", t.make_handler("SkyrimSE", "Fomod"), 20,
                       "exact");
  ...
  SECTION("different stages are independent") {
    ...
    reg.register_claim("", "Deploy", deploy.make_handler("", "Deploy"), 5,
                       "deploy_wild");
